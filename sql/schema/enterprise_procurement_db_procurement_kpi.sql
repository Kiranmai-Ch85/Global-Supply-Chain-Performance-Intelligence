...
--
-- Table structure for table `procurement_kpi`
--

DROP TABLE IF EXISTS `procurement_kpi`;
...
CREATE TABLE `procurement_kpi` (
  ...
  `Defective_Units` int DEFAULT NULL,
  `Compliance` varchar(20) DEFAULT NULL,
  PRIMARY KEY (`PO_ID`),
...
-- Dump completed on 2026-07-26 22:33:02
